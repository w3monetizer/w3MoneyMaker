<template>
  <div id="welcome">
    ...
    <h1>Make Money @ AI speed</h1>
    <p><span class="red-text">colab</span> >> <span class="yellow-text">combine</span> >> <span class="blue-text">monetize</span> 24/7 - 3rd gen DNA OS</p>
    <div class="cta">
